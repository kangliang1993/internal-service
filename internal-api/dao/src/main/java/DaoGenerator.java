...
public class DaoGenerator {
    ...
    public static String tableName = "partner";
...
//        gc.setOutputDir(projectPath + "/src/main/java");
        ...
        dsc.setUrl("jdbc:mysql://rm-2zer574r9s469yi8yo.mysql.rds.aliyuncs.com:3306/iot-platform?useUnicode=true&characterEncoding=utf-8&tinyInt1isBit=false&serverTimezone=GMT%2B8&verifyServerCertificate=false&useSSL=false");
//        dsc.setSchemaName("lips");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("apiservice");
        dsc.setPassword("lipsapiservice");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
//        pc.setModuleName("lips");
        pc.setParent("com.lips.dao." + tableName);
