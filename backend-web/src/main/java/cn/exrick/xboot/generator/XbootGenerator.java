...
public class XbootGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.exrick.xboot.modules.your.com.internal.service";
    ...
    private static void generateCode(GroupTemplate gt) throws IOException{
        ...
        Template serviceTemplate = gt.getTemplate("com.internal.service.btl");
